__int64 __fastcall view_reply(__int64 a1, char *a2, unsigned int a3)
{
  char *v4; // r12
  __int64 v6; // rbp
  __int64 v7; // rbx
  ...
  void *v94; // rax
  CHAR *v95; // rdx
  void *Src; // [rsp+38h] [rbp-520h] BYREF
  void *v97; // [rsp+40h] [rbp-518h]
  __int64 v98; // [rsp+48h] [rbp-510h]
  char *Source; // [rsp+50h] [rbp-508h]
  unsigned int v100; // [rsp+5Ch] [rbp-4FCh]
  void *v101[2]; // [rsp+60h] [rbp-4F8h] BYREF
  __int128 v102; // [rsp+70h] [rbp-4E8h]
  void *v103[2]; // [rsp+80h] [rbp-4D8h]
  void *v104; // [rsp+90h] [rbp-4C8h]
  char v105; // [rsp+A7h] [rbp-4B1h]
  void *Block; // [rsp+D0h] [rbp-488h]
  __int16 v107; // [rsp+E7h] [rbp-471h]
  char v108; // [rsp+E9h] [rbp-46Fh]
  __time64_t Time; // [rsp+F8h] [rbp-460h] BYREF
  int v110; // [rsp+100h] [rbp-458h] BYREF
  CHAR *v111; // [rsp+108h] [rbp-450h]
  int v112; // [rsp+110h] [rbp-448h]
  __int64 v113; // [rsp+118h] [rbp-440h]
  int v114; // [rsp+120h] [rbp-438h]
  __int64 v115; // [rsp+128h] [rbp-430h]
  int v116; // [rsp+130h] [rbp-428h]
  __int64 v117; // [rsp+138h] [rbp-420h]
  int v118; // [rsp+140h] [rbp-418h]
  __int64 tm_mday; // [rsp+148h] [rbp-410h]
  int v120; // [rsp+150h] [rbp-408h]
  __int64 tm_hour; // [rsp+158h] [rbp-400h]
  int v122; // [rsp+160h] [rbp-3F8h]
  __int64 tm_min; // [rsp+168h] [rbp-3F0h]
  int v124; // [rsp+170h] [rbp-3E8h]
  __int64 tm_sec; // [rsp+178h] [rbp-3E0h]
  char v126; // [rsp+50Fh] [rbp-49h]
