void __fastcall sub_375BB0(__int64 Unit, __int64 a2)
{
  unsigned int v4; // eax
  unsigned int v5; // eax
  __int64 v6; // rcx
  ...
  switch ( *(a2 + 0x18) )
  {
    ...
    case 0xF02F:
      ...
      if ( (*(*v27 + 0x10i64))(Unit + 0x50) && qword_4B507E8 && (dword_4B1C810 - 3) >= 2 )
      {
      ...
      if ( v71 )
      {
        if ( v75 > v77 )
        {
          ...
          if ( v78 )
          {
            ...
            sub_158CE00(v71 + 0x1D18, v71, &v337);
...
LABEL_375:
      ...
      if ( *(*(game + 0x420) + 0x3B0i64) )
      {
        ...
        *v337.m256i_i32 = *(v244 + 0xBC) + *(a2 + 0xD8);
        ...
        {
          sub_158CE00(v244 + 0x80, v244, &v337);
...
LABEL_462:
    ...
    case 0xF10A:
      ...
      if ( v118 == 0xFFFFFFFF )
      {
        ...
        {
          sub_158CE00(Unit + 0x600, Unit, &v337);
