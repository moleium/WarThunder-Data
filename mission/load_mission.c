__int64 __fastcall load_mission(__int64 a1, __int64 a2, int a3, char a4)
{
  ...
  __int64 v388; // rcx
  __int64 v389; // rdx
  unsigned int v390; // ebp
  bool v391; // cf
  unsigned __int64 v392; // rdi
  ...
  __int64 *v571; // r13
  unsigned int v572; // ebp
  __int64 v573; // rdx
  unsigned int v574; // ebx
  __int64 v575; // rsi
  unsigned int v576; // eax
  unsigned int v577; // ebp
  __int64 v578; // rdx
  __int64 v579; // rcx
  __int64 v580; // rdx
  ...
  __int64 *v608; // r13
  unsigned int v609; // ebp
  __int64 v610; // rdx
  unsigned int v611; // ebx
  __int64 v612; // rsi
  unsigned int v613; // eax
  unsigned int v614; // ebp
  __int64 v615; // rdx
  __int64 v616; // rcx
  __int64 v617; // rdx
  unsigned int v618; // edi
  __int64 *v619; // rdx
  unsigned int v620; // eax
  unsigned int v621; // ebp
  const char *v622; // rax
  const char *v623; // rsi
  size_t v624; // rbx
  void *v625; // rax
  ...
  __int64 v635; // rbp
  __int64 v636; // rdi
  unsigned int v637; // r13d
  unsigned int v638; // ebp
  __int64 v639; // rax
  int v640; // esi
  int v641; // eax
  unsigned int v642; // eax
  unsigned __int16 v643; // ax
  ...
  __int64 v673; // rcx
  __int64 v674; // rdx
  unsigned int v675; // ebp
  unsigned int v676; // edi
  __int64 v677; // rax
  int v678; // esi
  __int64 *v679; // rbx
  int v680; // eax
  ...
  int v699; // ecx
  unsigned int v700; // edx
  unsigned int v701; // eax
  __int64 v702; // r12
  unsigned int v703; // ebx
  unsigned int v704; // ecx
  ...
  CHAR *v716; // rdx
  __int64 v717; // rdi
  unsigned int v718; // r14d
  unsigned int v719; // ebp
  __int64 v720; // rax
  int v721; // esi
  int v722; // eax
  ...
  __int64 *v726; // rdx
  unsigned int v727; // r14d
  __int64 v728; // rdi
  unsigned int v729; // esi
  __int64 v730; // rbx
  unsigned int v731; // eax
  unsigned int v732; // r14d
  __int64 v733; // rbx
  __int64 v734; // rbp
  __int64 v735; // rdi
  ...
  int v759; // esi
  __int64 v760; // rdi
  unsigned int v761; // r14d
  unsigned int v762; // ebp
  __int64 v763; // rax
  int v764; // eax
  ...
  __int64 *v768; // rdx
  unsigned int v769; // r14d
  __int64 v770; // rdi
  unsigned int v771; // esi
  __int64 v772; // rbx
  unsigned int v773; // eax
  unsigned int v774; // r14d
  __int64 v775; // rbx
  __int64 v776; // rbp
  __int64 v777; // rdi
  ...
  __int64 *v789; // rdx
  unsigned int v790; // r14d
  __int64 v791; // rdi
  unsigned int v792; // esi
  __int64 v793; // rbx
  unsigned int v794; // eax
  unsigned int v795; // r14d
  __int64 v796; // rbx
  __int64 v797; // rbp
  __int64 v798; // rdi
  ...
  int v801; // esi
  __int64 v802; // rdi
  unsigned int v803; // r14d
  unsigned int v804; // ebp
  __int64 v805; // rax
  int v806; // eax
  ...
  __int64 v818; // rbp
  __int64 v819; // rdi
  unsigned int v820; // esi
  __int64 *v821; // rdi
  int v822; // esi
  __int64 v823; // rdi
  unsigned int v824; // r14d
  unsigned int v825; // ebp
  __int64 v826; // rax
  int v827; // eax
  ...
  __int64 *v831; // rdx
  unsigned int v832; // r14d
  __int64 v833; // rdi
  unsigned int v834; // esi
  __int64 v835; // rbx
  unsigned int v836; // eax
  unsigned int v837; // r14d
  __int64 v838; // rbx
  __int64 v839; // rbp
  __int64 v840; // rdi
  unsigned int v841; // esi
  __int64 *v842; // rdi
  int v843; // esi
  __int64 v844; // rdi
  unsigned int v845; // r14d
  unsigned int v846; // ebp
  __int64 v847; // rax
  int v848; // eax
  ...
  __int64 *v852; // rdx
  unsigned int v853; // r14d
  __int64 v854; // rbp
  unsigned int v855; // edi
  __int64 v856; // rsi
  unsigned int v857; // eax
  unsigned int v858; // r14d
  __int64 v859; // rbp
  __int64 v860; // rbx
  __int64 v861; // rbp
  unsigned int v862; // esi
  __int64 *v863; // rbp
  int v864; // esi
  __int64 v865; // rdi
  unsigned int v866; // r14d
  unsigned int v867; // ebp
  __int64 v868; // rax
  int v869; // eax
  ...
  __int64 *v873; // rdx
  unsigned int v874; // r14d
  __int64 v875; // rdi
  unsigned int v876; // esi
  __int64 v877; // rbx
  unsigned int v878; // eax
  unsigned int v879; // r14d
  __int64 v880; // rbx
  __int64 v881; // rbp
  __int64 v882; // rdi
  unsigned int v883; // esi
  __int64 *v884; // rdi
  __int64 *v885; // r12
  __int64 v886; // rdi
  unsigned int v887; // r13d
  unsigned int v888; // r14d
  __int64 v889; // rax
  int v890; // esi
  int v891; // eax
  ...
  __int64 v903; // rcx
  __int64 v904; // rdi
  unsigned int v905; // esi
  __int64 *v906; // rdi
  int v907; // esi
  __int64 v908; // rdi
  unsigned int v909; // r14d
  unsigned int v910; // ebp
  __int64 v911; // rax
  int v912; // eax
  ...
  __int64 *v916; // rdx
  unsigned int v917; // r14d
  __int64 v918; // rdi
  unsigned int v919; // esi
  __int64 v920; // rbx
  unsigned int v921; // eax
  unsigned int v922; // r14d
  __int64 v923; // rbx
  __int64 v924; // rbp
  __int64 v925; // rdi
  unsigned int v926; // esi
  __int64 *v927; // rdi
  int v928; // esi
  __int64 v929; // rdi
  unsigned int v930; // r14d
  unsigned int v931; // ebp
  __int64 v932; // rax
  int v933; // eax
  unsigned int v934; // eax
  int v935; // eax
  unsigned int v936; // r9d
  __int64 *v937; // rdx
  unsigned int v938; // r14d
  __int64 v939; // rdi
  unsigned int v940; // esi
  __int64 v941; // rbx
  ...
  int v949; // esi
  __int64 v950; // rdi
  unsigned int v951; // r14d
  unsigned int v952; // ebp
  __int64 v953; // rax
  int v954; // eax
  unsigned int v955; // eax
  int v956; // edx
  unsigned int v957; // ebp
  __int64 *v958; // r8
  unsigned int v959; // r14d
  __int64 v960; // rdi
  unsigned int v961; // esi
  __int64 v962; // rax
  unsigned int v963; // edx
  unsigned int v964; // r14d
  __int64 v965; // rax
  __int64 v966; // rbp
  __int64 v967; // rdi
  ...
  unsigned int v991; // ebp
  __int64 v992; // rax
  int v993; // esi
  int v994; // eax
  unsigned int v995; // eax
  int v996; // eax
  unsigned int v997; // ecx
  ...
  __int64 v1005; // rcx
  __int64 v1006; // rdx
  unsigned int v1007; // ebp
  __int64 v1008; // r12
  unsigned __int16 v1009; // ax
  unsigned __int64 v1010; // r13
  void *v1011; // rbp
  ...
  unsigned int v1027; // ecx
  __int64 *v1028; // rdi
  __int64 v1029; // rdi
  const char *v1030; // rdi
  size_t v1031; // rbx
  void *v1032; // rax
  __int64 v1033; // rdx
  __int64 *v1034; // rbp
  __int64 v1035; // rdi
  unsigned int v1036; // ebx
  unsigned int v1037; // r14d
  __int64 v1038; // rax
  int v1039; // esi
  int v1040; // eax
  unsigned int v1041; // eax
  int v1042; // eax
  unsigned int v1043; // ecx
  unsigned int v1044; // ebx
  __int64 v1045; // r12
  unsigned int v1046; // edx
  __int64 v1047; // rsi
  unsigned int v1048; // eax
  unsigned int v1049; // ebx
  __int64 v1050; // rdx
  __int64 v1051; // rcx
  __int64 v1052; // rdx
  unsigned int v1053; // ebp
  __int64 v1054; // r12
  unsigned __int16 v1055; // ax
  unsigned __int64 v1056; // rsi
  void *v1057; // rbx
  ...
  char v1071; // cl
  unsigned int v1072; // ebx
  unsigned int v1073; // ecx
  _QWORD *v1074; // rdi
  const char *v1075; // rbp
  size_t v1076; // r13
  void *v1077; // rax
  __int64 v1078; // rdx
  __int64 (__fastcall *v1079)(int, int, int, int, int, int, __int64, int); // rax
  __int64 v1080; // r15
  __int64 result; // rax
  _BYTE *v1082; // rax
  __int64 v1083; // rbx
  ...
  __int64 v1115; // rbp
  __int64 v1116; // rdi
  unsigned int v1117; // esi
  __int64 *v1118; // rdi
  int v1119; // esi
  __int64 v1120; // rdi
  unsigned int v1121; // r14d
  unsigned int v1122; // ebp
  __int64 v1123; // rax
  int v1124; // eax
  ...
  __int64 *v1128; // rdx
  unsigned int v1129; // r14d
  __int64 v1130; // rdi
  unsigned int v1131; // esi
  __int64 v1132; // rbx
  unsigned int v1133; // eax
  unsigned int v1134; // r14d
  __int64 v1135; // rbx
  __int64 v1136; // rbp
  __int64 v1137; // rdi
  ...
  int v1140; // esi
  __int64 v1141; // rdi
  unsigned int v1142; // r14d
  unsigned int v1143; // ebp
  __int64 v1144; // rax
  int v1145; // eax
  unsigned int v1146; // eax
  int v1147; // eax
  unsigned int v1148; // r9d
  __int64 *v1149; // rdx
  unsigned int v1150; // r14d
  __int64 v1151; // rdi
  unsigned int v1152; // esi
  __int64 v1153; // rbx
  unsigned int v1154; // eax
  unsigned int v1155; // r14d
  __int64 v1156; // rbx
  __int64 v1157; // rbp
  __int64 v1158; // rdi
  unsigned int v1159; // esi
  __int64 *v1160; // rdi
  __int64 v1161; // [rsp+20h] [rbp-198h]
  const char *v1162; // [rsp+30h] [rbp-188h] BYREF
  char *v1163; // [rsp+38h] [rbp-180h] BYREF
  __int64 v1164; // [rsp+40h] [rbp-178h]
  __int128 v1165; // [rsp+48h] [rbp-170h] BYREF
  __int64 v1166; // [rsp+58h] [rbp-160h]
  int v1167; // [rsp+60h] [rbp-158h]
  __int64 v1168; // [rsp+68h] [rbp-150h]
  __int64 *v1169; // [rsp+78h] [rbp-140h]
  char *v1170; // [rsp+80h] [rbp-138h]
  int *v1171; // [rsp+88h] [rbp-130h]
  char v1172; // [rsp+93h] [rbp-125h]
  unsigned int v1173; // [rsp+94h] [rbp-124h]
  char *Str; // [rsp+98h] [rbp-120h]
  void *Src; // [rsp+A0h] [rbp-118h]
  __int64 v1176; // [rsp+A8h] [rbp-110h]
  __int64 v1177; // [rsp+B0h] [rbp-108h] BYREF
  _QWORD *v1178; // [rsp+B8h] [rbp-100h]
  __int128 v1179; // [rsp+C0h] [rbp-F8h] BYREF
  void *v1180; // [rsp+D0h] [rbp-E8h]
  __int64 v1181; // [rsp+D8h] [rbp-E0h] BYREF
  __int64 v1182; // [rsp+E0h] [rbp-D8h]
  __int64 v1183; // [rsp+E8h] [rbp-D0h]
  __int64 (__fastcall **v1184)(void *); // [rsp+F0h] [rbp-C8h] BYREF
  const char *v1185; // [rsp+F8h] [rbp-C0h]
  __int128 v1186; // [rsp+100h] [rbp-B8h] BYREF
  __int64 v1187; // [rsp+110h] [rbp-A8h]
  char v1188[16]; // [rsp+118h] [rbp-A0h] BYREF
  char v1189; // [rsp+128h] [rbp-90h] BYREF
