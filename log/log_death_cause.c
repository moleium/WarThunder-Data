...
LABEL_11:
        ...
        {
          sub_B27BC0(qword_4B19AA0 + 0x5A8, "hint:died_from_ammo_explosion:hide", &qword_4B67850, v18);
          byte_4B1993D = 0;
        }
LABEL_21:
    ...
    if ( (v36 - 0x11) <= 1 )
    {
      ...
      if ( v38 <= v39 && qword_4B19AA0 && (byte_4B1993D & 1) == 0 )
      {
        sub_B27BC0(qword_4B19AA0 + 0x5A8, "hint:died_from_ammo_explosion:show", &qword_4B67850, v18);
        byte_4B1993D = 1;
      }
    }
...
LABEL_25:
  ...
  if ( *(v32 + 0x254) )
  {
    ...
    {
      sub_B27BC0(qword_4B19AA0 + 0x5A8, "hint:press_a_continue:show", &v83, v55);
      byte_4B1993E = 1;
    }
    sub_1458FF0(&v83);
  }
...
LABEL_39:
    if ( qword_4B19AA0 && (byte_4B1993E & 1) != 0 )
    {
      sub_B27BC0(qword_4B19AA0 + 0x5A8, "hint:press_a_continue:hide", &qword_4B67850, v18);
      byte_4B1993E = 0;
    }
  }
  LOBYTE(v17) = 1;
