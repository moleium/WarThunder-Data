__int64 (__fastcall **__fastcall unknown_replay_stuff(__int64 a1))(void *Block)
{
  _QWORD *v2; // r12
  __int64 v3; // rax
  __int64 v4; // rdx
  ...
  __int64 (__fastcall **v110)(void *); // [rsp+38h] [rbp-60h] BYREF
  _QWORD *v111; // [rsp+40h] [rbp-58h]
  __int128 v112; // [rsp+48h] [rbp-50h] BYREF
  char v113; // [rsp+58h] [rbp-40h] BYREF
  char v114; // [rsp+60h] [rbp-38h] BYREF
