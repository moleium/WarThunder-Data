__int64 __fastcall play_replay(_QWORD *a1)
{
  ...
  char v19; // al
  unsigned int lpMaximumApplicationAddress_high; // ecx
  int lpMaximumApplicationAddress; // eax
  bool v22; // bl
  int *v23; // rax
  ...
  struct _SYSTEM_INFO *p_SystemInfo; // r15
  ...
  const char *v94; // rcx
  __int64 v95; // rdx
  __int64 (__fastcall **v96)(void *); // rsi
  __int64 v97; // rax
  float v98; // xmm0_4
  float v99; // xmm1_4
  void *v100; // rdi
  ...
  _QWORD *v346; // rbx
  DWORD dwOemId; // edi
  DWORD dwPageSize; // r8d
  _QWORD *lpMinimumApplicationAddress; // rsi
  __int64 v350; // rbp
  __int64 v351; // rax
  __int64 v352; // rcx
  int v353; // edx
  ...
  __int64 v366; // rbx
  __int64 v367; // rbp
  unsigned int v369; // [rsp+28h] [rbp-800h]
  int v370; // [rsp+28h] [rbp-800h]
  unsigned int v371; // [rsp+30h] [rbp-7F8h]
  int v372; // [rsp+30h] [rbp-7F8h]
  __int64 (__fastcall **v373)(void *); // [rsp+30h] [rbp-7F8h]
  _BYTE *v374; // [rsp+38h] [rbp-7F0h]
  void *v375; // [rsp+38h] [rbp-7F0h]
  void *v376; // [rsp+40h] [rbp-7E8h] BYREF
  void *v377; // [rsp+48h] [rbp-7E0h]
  size_t v378; // [rsp+50h] [rbp-7D8h]
  void *Src; // [rsp+58h] [rbp-7D0h] BYREF
  void *v380; // [rsp+60h] [rbp-7C8h]
  size_t Size; // [rsp+68h] [rbp-7C0h]
  void *v382; // [rsp+70h] [rbp-7B8h] BYREF
  _QWORD *v383; // [rsp+78h] [rbp-7B0h]
  size_t v384; // [rsp+80h] [rbp-7A8h] BYREF
  __int64 v385; // [rsp+90h] [rbp-798h]
  _QWORD *v386; // [rsp+98h] [rbp-790h]
  __int64 (__fastcall **v387)(void *); // [rsp+A0h] [rbp-788h] BYREF
  _QWORD *v388; // [rsp+A8h] [rbp-780h]
  __int128 v389; // [rsp+B0h] [rbp-778h] BYREF
  __int64 v390; // [rsp+C0h] [rbp-768h]
  _BYTE *v391; // [rsp+C8h] [rbp-760h]
  __time64_t Time; // [rsp+D0h] [rbp-758h] BYREF
  _QWORD *v393; // [rsp+D8h] [rbp-750h]
  void *v394; // [rsp+E0h] [rbp-748h]
  void *v395; // [rsp+E8h] [rbp-740h]
  __int64 (__fastcall **v396)(void *); // [rsp+F0h] [rbp-738h] BYREF
  __int64 v397; // [rsp+F8h] [rbp-730h]
  _OWORD v398[13]; // [rsp+100h] [rbp-728h] BYREF
  char Str2[284]; // [rsp+1D4h] [rbp-654h] BYREF
  unsigned int v400; // [rsp+2F0h] [rbp-538h]
  struct _SYSTEM_INFO SystemInfo; // [rsp+300h] [rbp-528h] BYREF
  char v402; // [rsp+5B0h] [rbp-278h]
  unsigned int v403; // [rsp+688h] [rbp-1A0h]
...
LABEL_38:
  if ( (v16 & 1) != 0 && (v16 & 0xFFFFFFFFFFFFFFFEui64) != 0 )
  {
    sub_1655370();
  }
  else if ( fclose(v16) )
  {
    v27 = *errno();
    SystemInfo.lpMinimumApplicationAddress = v16;
...
LABEL_106:
        ...
        *(v54 + v53) = 1;
        ...
        v56 = sub_145DDB0(&qword_4B1BF08, "file");
