    ...
    if ( v37 )
    {
      if ( g_net )
      {
        ...
        if ( v39 != v38 )
        {
          ...
          if ( v39 != v38 )
          {
            on_reflection_var_changed(v84, Unit, &Src);
            *(Unit + 0x1110) = Src;
          }
        }
      }
      ...
      {
        setarmy(*(qword_4B50080 + a6), a5, "Unit");
      }
  ...
  if ( v46 != (v46 | 0x40000) )
  {
    *(Unit + 0x1058) = v47;
    if ( ((v47 ^ v46) & 0x38C5C2CE) != 0 )
      on_reflection_var_changed(v86, Unit, Unit + 0x1050);
  }
  *(Unit + 0x160) = 0i64;
  *(Unit + 0x1140) = 0;
  v48 = *(Unit + 0x4C8);
...
LABEL_66:
  ...
  *v83 = *v87;
  ...
  {
    on_reflection_var_changed(Unit + 0x1900, Unit, &Src);
