void __fastcall setarmy(__int64 Player, char a2, __int64 a3)
{
  ...
  if ( *(Player + 0x208) != a2 )
  {
    *(Player + 0x80) |= 4u;
    LOBYTE(v18) = a2;
    on_reflection_var_changed(Player + 0x1E8, Player, &v18);
    v5 = v18;
    *(Player + 0x208) = v18;
    ...
    if ( SomeWhatUnit )
    {
      ...
      if ( AlsoUnitInfo != v5 )
      {
        ...
        if ( AlsoUnitInfo != v5 )
        {
          on_reflection_var_changed(SomeWhatUnit + 0x10F0, SomeWhatUnit, &v18);
...
LABEL_9:
      ...
      if ( UnitInfo != v10 )
      {
        ...
        if ( UnitInfo != v10 )
        {
          on_reflection_var_changed(OwnedUnit + 0x21E, OwnedUnit, &v18);
