  ...
  if ( *(a1 + 0x4F0) )
  {
    ...
    if ( v196 < v192 )
    {
      ...
      else
      {
        ...
        if ( v199 > *&epsilon_unk || (v201 = 0i64, v199 < *&dword_449F1AC) )
        {
...
LABEL_259:
  ...
  *&v434 = v205;
  ...
  if ( v206 )
  {
    ...
    {
      v208 = *(HudInfo + 0x1E);
      v209.m128_i32[0] = *(HudInfo + 0x1F);
    }
    else
    {
      v208 = *(HudInfo + 0x1A);
      v209.m128_i32[0] = *(HudInfo + 0x1B);
    }
  }
  else
  {
    v208 = *(HudInfo + 0x1C);
    v209.m128_i32[0] = *(HudInfo + 0x1D);
  }
...
LABEL_286:
  ...
  *a11 = v225;
  ...
  if ( v234 > *&epsilon_unk )
    v235 = Y / v234;
  v428 = a4;
  if ( a6 > *&epsilon_unk || (v236 = 0.0, a6 < *&dword_449F1AC) )
    v236 = Y / a6;
  v413 = *(v100 + 0x1C);
  v237 = *(a1 + 0x2B0);
  v238 = v237[0x9A];
  ...
  else
  {
    ...
    else
    {
      ...
      if ( v247 > *&epsilon_unk || (v249 = 0i64, v247 < *&dword_449F1AC) )
      {
      ...
      if ( v334 == 5 || v334 == 3 )
      {
        ...
        if ( v356 < v355.m128_f32[0] )
        {
          ...
          else
          {
            ...
            if ( v359 > *&epsilon_unk || (v361 = 0i64, v359 < *&dword_449F1AC) )
            {
...
LABEL_439:
          ...
          if ( *&dword_448790C < *(v382 + 0x18) )
          {
            ...
            if ( v383 > 0 )
            {
              ...
              if ( v387 > *&epsilon_unk || (v390 = 0i64, v387 < *&dword_449F1AC) )
              {
                v390 = LODWORD(Y);
  ...
  if ( (*(v22 + 0x58) & 4) != 0 )
  {
    ...
    if ( v23 > 0.0 )
    {
      ...
      *(&v434 + 2) = v23;
      ...
      {
        sub_169AE50(&entity_manager, v24, &v434);
      }
      v22 = *(a1 + 8);
    }
  }
      ...
      *(a1 + 0x43C) = v87;
      ...
      if ( v88 )
      {
        ...
        *v90 = &off_44A9350;
        v90[1] = v88;
        v74 = 0;
        add_delayed_callback(&controller_do_reset_input, v90, 0i64, 0i64, "DelayedAction @\n\t..\\..\\skyquake\\prog\\weapon\\gun.cpp(457):");
        v40 = v89;
      }
      else
      {
...
LABEL_147:
  ...
  *&v434 = 0x1000C5F5446EAi64;
  ...
  {
    v126 = 0x41C64E6D * g_rnd_seed + 0x3039;
    v127 = game;
    g_rnd_seed = v126;
    ...
    g_rnd_seed = 0x41C64E6D * v126 + 0x3039;
    if ( v128 )
    {
      v132 = *(v127 + 0x440);
      v133 = *(v132 + 0x3F0);
          ...
          if ( *(v142 + 4) >= *(*(game + 0x498) + 0x1FA0i64) )
          {
            ...
            *(v146 + 0xFA4) = v147;
            if ( (*(v146 + 0x58) & 4) != 0 && (*(v146 + 0x10B8) || *(v146 + 0x74C)) )
            {
              ...
              if ( *(v146 + 0xFC8) )
              {
                on_reflection_var_changed(v146 + 0xFA8, v146, &v434);
                result = v434;
                *(v146 + 0xFC8) = v434;
              }
            }
