__int64 __fastcall change_unit(__int64 a1)
{
  ...
  __int64 v183; // rax
  __int64 v184; // rcx
  int Str; // [rsp+20h] [rbp-748h]
  int Stra; // [rsp+20h] [rbp-748h]
  int Strb; // [rsp+20h] [rbp-748h]
  int v188; // [rsp+28h] [rbp-740h]
  int v189; // [rsp+28h] [rbp-740h]
  int v190; // [rsp+38h] [rbp-730h]
  _QWORD *v191; // [rsp+70h] [rbp-6F8h]
  __int64 v192; // [rsp+78h] [rbp-6F0h] BYREF
  void *Block[2]; // [rsp+80h] [rbp-6E8h] BYREF
  __int128 v194; // [rsp+90h] [rbp-6D8h]
  int v195; // [rsp+A0h] [rbp-6C8h]
  float v196; // [rsp+A4h] [rbp-6C4h]
  float v197; // [rsp+A8h] [rbp-6C0h]
  float v198; // [rsp+ACh] [rbp-6BCh]
  CHAR *v199; // [rsp+B8h] [rbp-6B0h] BYREF
  void *v200; // [rsp+C0h] [rbp-6A8h]
  unsigned __int64 v201; // [rsp+C8h] [rbp-6A0h]
  unsigned int v202; // [rsp+D0h] [rbp-698h]
  unsigned int v203; // [rsp+D4h] [rbp-694h]
  int v204[2]; // [rsp+D8h] [rbp-690h]
  CHAR *v205; // [rsp+E0h] [rbp-688h] BYREF
  void *v206; // [rsp+E8h] [rbp-680h]
  __int64 v207; // [rsp+F0h] [rbp-678h]
  _BYTE *v208; // [rsp+F8h] [rbp-670h] BYREF
  unsigned __int64 v209; // [rsp+100h] [rbp-668h] BYREF
  int v210; // [rsp+108h] [rbp-660h]
  __int64 v211[2]; // [rsp+110h] [rbp-658h] BYREF
  __int64 *v212; // [rsp+120h] [rbp-648h]
  __int64 v213; // [rsp+128h] [rbp-640h]
  __int16 v214; // [rsp+130h] [rbp-638h]
  __int128 v215; // [rsp+140h] [rbp-628h] BYREF
  __int128 v216; // [rsp+150h] [rbp-618h]
  __int128 v217; // [rsp+160h] [rbp-608h]
  __int64 v218[4]; // [rsp+178h] [rbp-5F0h] BYREF
  CHAR *v219; // [rsp+198h] [rbp-5D0h] BYREF
  __int64 *v220; // [rsp+1A0h] [rbp-5C8h]
  void **v221; // [rsp+1A8h] [rbp-5C0h]
  __int64 *v222; // [rsp+1B0h] [rbp-5B8h]
  __int64 v223; // [rsp+1B8h] [rbp-5B0h]
  __int128 v224; // [rsp+1C0h] [rbp-5A8h] BYREF
  void **v225; // [rsp+1D0h] [rbp-598h]
  __int64 *v226; // [rsp+1D8h] [rbp-590h]
  CHAR *v227; // [rsp+1E0h] [rbp-588h]
  CHAR *v228; // [rsp+1E8h] [rbp-580h]
  CHAR *v229; // [rsp+1F0h] [rbp-578h]
  CHAR *v230; // [rsp+1F8h] [rbp-570h]
  CHAR *v231; // [rsp+200h] [rbp-568h]
  CHAR *v232; // [rsp+208h] [rbp-560h]
  unsigned __int64 v233; // [rsp+210h] [rbp-558h]
  unsigned int v234; // [rsp+218h] [rbp-550h]
  unsigned int v235; // [rsp+21Ch] [rbp-54Ch]
  unsigned int v236; // [rsp+220h] [rbp-548h]
  int v237; // [rsp+224h] [rbp-544h]
  const char *v238; // [rsp+228h] [rbp-540h]
  __int64 v239; // [rsp+230h] [rbp-538h]
  int v240; // [rsp+238h] [rbp-530h]
  char v241; // [rsp+23Ch] [rbp-52Ch]
  char v242; // [rsp+23Dh] [rbp-52Bh]
  bool v243; // [rsp+23Eh] [rbp-52Ah]
  char v244; // [rsp+23Fh] [rbp-529h]
  char v245; // [rsp+240h] [rbp-528h]
  _BYTE v246[12]; // [rsp+244h] [rbp-524h]
  __int64 v247; // [rsp+250h] [rbp-518h]
  __int16 v248; // [rsp+258h] [rbp-510h]
  char v249[32]; // [rsp+260h] [rbp-508h] BYREF
  CHAR *v250; // [rsp+280h] [rbp-4E8h] BYREF
  __int64 v251; // [rsp+288h] [rbp-4E0h]
  int v252; // [rsp+290h] [rbp-4D8h]
  __int64 v253[4]; // [rsp+298h] [rbp-4D0h] BYREF
  unsigned __int64 v254; // [rsp+2B8h] [rbp-4B0h] BYREF
  int v255; // [rsp+2C0h] [rbp-4A8h]
  __int64 v256[4]; // [rsp+2C8h] [rbp-4A0h] BYREF
  CHAR *v257; // [rsp+2E8h] [rbp-480h] BYREF
  __int64 v258; // [rsp+2F0h] [rbp-478h]
  int v259; // [rsp+2F8h] [rbp-470h]
  void *v260; // [rsp+300h] [rbp-468h] BYREF
  const char *v261; // [rsp+308h] [rbp-460h]
  int v262; // [rsp+310h] [rbp-458h]
  unsigned __int8 v263; // [rsp+317h] [rbp-451h]
  __int64 v264; // [rsp+318h] [rbp-450h]
  int v265; // [rsp+320h] [rbp-448h]
  __int64 v266; // [rsp+328h] [rbp-440h]
  char v267[16]; // [rsp+350h] [rbp-418h] BYREF
  char v268[296]; // [rsp+360h] [rbp-408h] BYREF
  __int64 v269; // [rsp+488h] [rbp-2E0h]
  __int64 v270; // [rsp+490h] [rbp-2D8h]
  int v271; // [rsp+4A8h] [rbp-2C0h]
  int v272; // [rsp+4F0h] [rbp-278h] BYREF
  unsigned __int64 v273; // [rsp+4F8h] [rbp-270h]
  int v274; // [rsp+500h] [rbp-268h]
  __int64 v275; // [rsp+508h] [rbp-260h]
  int v276; // [rsp+510h] [rbp-258h]
  __int64 v277; // [rsp+518h] [rbp-250h]
  char *v278; // [rsp+540h] [rbp-228h]
  CHAR *v279; // [rsp+548h] [rbp-220h]
  CHAR *v280; // [rsp+550h] [rbp-218h]
  int v281; // [rsp+558h] [rbp-210h] BYREF
  char v282[32]; // [rsp+578h] [rbp-1F0h] BYREF
  char v283[32]; // [rsp+598h] [rbp-1D0h] BYREF
  unsigned int v284; // [rsp+5B8h] [rbp-1B0h]
  int v285; // [rsp+5BCh] [rbp-1ACh]
  unsigned int v286; // [rsp+5C0h] [rbp-1A8h]
  int v287; // [rsp+5C4h] [rbp-1A4h]
  char v288; // [rsp+5C8h] [rbp-1A0h]
  __int64 v289; // [rsp+5CCh] [rbp-19Ch]
  char v290; // [rsp+690h] [rbp-D8h]
  char v291; // [rsp+691h] [rbp-D7h]
  char v292; // [rsp+693h] [rbp-D5h]
  unsigned int v293; // [rsp+694h] [rbp-D4h]
  char v294[64]; // [rsp+6A0h] [rbp-C8h] BYREF
  __int128 v295[3]; // [rsp+6E0h] [rbp-88h] BYREF
        ...
        if ( *v33 )
        {
          if ( *(v134 + 0x858) == 3 )
          {
            ...
            *(v133 + 0x39B0) = v134;
            ...
            if ( *(v134 + 0xE76) != v260 )
            {
              sub_158CE00(v134 + 0x39B8, v134, &v260);
              *(v134 + 0xE76) = v260;
              v133 = v192;
            }
...
LABEL_254:
      ...
      *(v143 + 0x20) = 0;
      ...
      if ( qword_4B507E8 && !*(qword_4B507E8 + 0x60) || (v157 = *(game + 0x450)) != 0 && *(v157 + 0x5CA) )
      {
        LOBYTE(v156) = 1;
