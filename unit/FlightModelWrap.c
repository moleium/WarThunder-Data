double __fastcall FlightModelWrap(LARGE_INTEGER Unit, LARGE_INTEGER *a2, __int64 a3, __int64 a4, char a5, char a6)
{
  ...
  __int64 v367; // rbp
  __int64 j; // rbx
  LARGE_INTEGER v369; // rdi
  __int64 v370; // rsi
  unsigned __int64 v371; // rdi
  __int64 v372; // rsi
  unsigned __int64 v373; // rcx
  unsigned __int64 v374; // rax
  LARGE_INTEGER v375; // rdx
  __int64 v376; // rbp
  __int128 v377; // xmm0
  __int128 v378; // xmm1
  ...
  __int64 v409; // rbp
  __int64 m; // rbx
  LARGE_INTEGER v411; // rdi
  __int64 v412; // rcx
  unsigned __int64 v413; // rdi
  __int64 v414; // rcx
  unsigned __int64 v415; // rax
  int v416; // ecx
  LARGE_INTEGER v417; // rdx
  __int64 v418; // rbp
  __int128 v419; // xmm0
  __int128 v420; // xmm1
  __int64 v421; // rsi
  ...
  int v466; // eax
  unsigned int v467; // ecx
  unsigned int v468; // esi
  unsigned int v469; // ebp
  __int64 v470; // rdi
  ...
  unsigned int v491; // ebx
  __int64 v492; // rax
  int v493; // ebp
  int v494; // eax
  unsigned int v495; // eax
  int v496; // eax
  unsigned int v497; // ecx
  ...
  __int64 v505; // rcx
  __int64 v506; // rdx
  unsigned int v507; // ebp
  char *v508; // rsi
  int v509; // eax
  __int64 v510; // r14
  __int64 v511; // rdi
  unsigned int v512; // r15d
  ...
  __int64 v522; // rbx
  unsigned int v523; // ebp
  __int64 v524; // rdi
  unsigned int v525; // eax
  unsigned int v526; // r15d
  __int64 v527; // rbp
  __int64 v528; // rcx
  __int64 v529; // rbx
  ...
  int v603; // eax
  unsigned int v604; // ecx
  __int64 v605; // rax
  unsigned __int64 v606; // rbp
  __int64 *v607; // rdx
  __int64 *v608; // r14
  ...
  __int64 n; // rcx
  _QWORD *v624; // rcx
  LARGE_INTEGER v625; // rax
  LARGE_INTEGER v626; // rbp
  char *v627; // rdx
  _BYTE *v628; // rax
  __int64 v629; // rax
  int *v630; // rbp
  __int64 v631; // rbx
  int v632; // esi
  unsigned int v633; // ebp
  __int64 v634; // rax
  int v635; // edi
  __int64 v636; // rax
  unsigned __int8 **v637; // rax
  ...
  __int64 v647; // rbp
  char *v648; // rax
  unsigned __int64 v649; // rdx
  char *v650; // rcx
  unsigned __int64 v651; // rdx
  __int64 v652; // rbx
  int v653; // esi
  unsigned int v654; // ebp
  __int64 v655; // rax
  int v656; // edi
  char *v657; // rcx
  unsigned int v658; // eax
  char *v659; // rax
  unsigned int v660; // esi
  unsigned int v661; // ecx
  char *v662; // rax
  int v663; // eax
  int v664; // eax
  __int64 v665; // rax
  ...
  __int64 v680; // r15
  __int64 v681; // rbp
  unsigned int v682; // r14d
  __int64 v683; // rsi
  __int64 v684; // r8
  CHAR *v685; // rbx
  __int64 v686; // rcx
  unsigned int v687; // eax
  unsigned __int64 v688; // rdi
  __int64 v689; // rbx
  unsigned int v690; // esi
  unsigned int v691; // r14d
  __int64 v692; // rax
  int v693; // edi
  int v694; // eax
  ...
  unsigned int v703; // esi
  __int64 v704; // rdx
  __int64 v705; // rcx
  __int64 v706; // rdx
  unsigned int v707; // ebp
  __int64 v708; // r12
  int v709; // r15d
  ...
  __int64 v714; // rsi
  __int64 v715; // rdi
  unsigned __int64 v716; // rax
  int v717; // eax
  unsigned int v718; // eax
  int v719; // eax
  unsigned int v720; // ecx
  unsigned int v721; // esi
  __int64 v722; // rdi
  unsigned int v723; // edx
  __int64 v724; // rbx
  unsigned int v725; // eax
  unsigned int v726; // esi
  __int64 v727; // rdx
  __int64 v728; // rcx
  __int64 v729; // rdx
  unsigned int v730; // ebp
  __int64 *v731; // rdi
  __int64 v732; // rdx
  __int64 v733; // rsi
  __int64 v734; // rbx
  ...
  unsigned int v750; // ebx
  unsigned __int64 v751; // rdi
  __int64 v752; // rax
  bool v753; // sf
  __int64 v754; // r15
  int v755; // xmm6_4
  ...
  _OWORD *v810; // rax
  __int64 v811; // rdi
  unsigned __int64 v812; // rsi
  _BYTE *v813; // rax
  __int64 v814; // r8
  _BYTE *v815; // rsi
  __int64 v816; // rcx
  unsigned int v817; // eax
  unsigned int v818; // edi
  unsigned __int64 v819; // rbx
  __int64 v820; // rdi
  unsigned int v821; // esi
  unsigned int v822; // r14d
  __int64 v823; // rax
  int v824; // ebx
  int v825; // eax
  ...
  __int64 v829; // r12
  unsigned int v830; // esi
  __int64 v831; // rdx
  unsigned int v832; // ebp
  __int64 v833; // rdi
  unsigned int v834; // eax
  unsigned int v835; // esi
  __int64 v836; // rdx
  __int64 v837; // rcx
  __int64 v838; // rdx
  ...
  __int64 v886; // rdi
  __int64 v887; // rbx
  unsigned int v888; // eax
  unsigned int v889; // ebp
  unsigned int v890; // edx
  __int64 v891; // rax
  __int64 v892; // rsi
  __int64 v893; // rdi
  unsigned int v894; // eax
  unsigned int v895; // ebx
  unsigned int v896; // edx
  _DWORD *v897; // rsi
  __int64 *v898; // rax
  __int64 *v899; // r12
  __int64 v900; // rbx
  unsigned int v901; // esi
  ...
  unsigned int v910; // edx
  __int64 v911; // rax
  __int64 v912; // rsi
  __int64 v913; // rdi
  unsigned int v914; // eax
  unsigned int v915; // ebx
  unsigned int v916; // edx
  int v917; // eax
  unsigned int v918; // eax
  int v919; // eax
  unsigned int v920; // ecx
  unsigned int v921; // esi
  unsigned int v922; // edx
  unsigned int v923; // eax
  unsigned int v924; // esi
  __int64 v925; // rdx
  __int64 v926; // rcx
  __int64 v927; // rdx
  unsigned int v928; // ebp
  unsigned int v929; // eax
  __int64 v930; // rdx
  __int64 v931; // r14
  __int64 v932; // rbp
  unsigned int v933; // r13d
  unsigned int v934; // r15d
  __int64 v935; // rax
  int v936; // ebx
  int v937; // eax
  unsigned int v938; // eax
  int v939; // eax
  unsigned int v940; // ecx
  __int64 v941; // rdx
  unsigned int v942; // r13d
  __int64 v943; // rbp
  unsigned int v944; // ebx
  __int64 v945; // rdi
  unsigned int v946; // eax
  unsigned int v947; // r13d
  __int64 v948; // rbp
  __int64 v949; // rcx
  __int64 v950; // rbp
  unsigned int v951; // edi
  int v952; // ebp
  float v953; // xmm0_4
  float v954; // xmm1_4
  float v955; // xmm0_4
  __int64 v956; // rdx
  __int64 v957; // [rsp+20h] [rbp-278h]
  LARGE_INTEGER *v958; // [rsp+20h] [rbp-278h]
  __int64 *v959; // [rsp+38h] [rbp-260h]
  CHAR *v960; // [rsp+40h] [rbp-258h]
  __int64 v961; // [rsp+40h] [rbp-258h]
  char v962; // [rsp+40h] [rbp-258h]
  LARGE_INTEGER v963; // [rsp+48h] [rbp-250h]
  LARGE_INTEGER PerformanceCount[2]; // [rsp+50h] [rbp-248h] BYREF
  __int128 v965; // [rsp+60h] [rbp-238h]
  __int128 v966; // [rsp+70h] [rbp-228h]
  __int128 v967; // [rsp+80h] [rbp-218h]
  __int128 v968; // [rsp+90h] [rbp-208h]
  __int128 v969; // [rsp+A0h] [rbp-1F8h]
  __int128 v970; // [rsp+B0h] [rbp-1E8h]
  __int128 v971; // [rsp+C0h] [rbp-1D8h]
  __int64 v972; // [rsp+D8h] [rbp-1C0h]
  int v973[2]; // [rsp+E0h] [rbp-1B8h]
  void *v974; // [rsp+E8h] [rbp-1B0h]
  __int64 v975; // [rsp+F0h] [rbp-1A8h] BYREF
  __int64 v976; // [rsp+F8h] [rbp-1A0h]
  __int64 v977; // [rsp+100h] [rbp-198h]
  void *Block; // [rsp+108h] [rbp-190h] BYREF
  __int64 v979; // [rsp+110h] [rbp-188h]
  int v980; // [rsp+118h] [rbp-180h]
  char v981; // [rsp+11Fh] [rbp-179h]
  void *v982; // [rsp+128h] [rbp-170h]
  __int128 v983[2]; // [rsp+130h] [rbp-168h] BYREF
  __int64 v984; // [rsp+158h] [rbp-140h]
  __int64 v985; // [rsp+160h] [rbp-138h]
  int v986; // [rsp+168h] [rbp-130h] BYREF
  int v987; // [rsp+16Ch] [rbp-12Ch]
  int v988[8]; // [rsp+170h] [rbp-128h] BYREF
  char v989[15]; // [rsp+190h] [rbp-108h] BYREF
  char v990; // [rsp+19Fh] [rbp-F9h]
  __int64 v991; // [rsp+1A8h] [rbp-F0h] BYREF
  unsigned __int16 v992; // [rsp+1B6h] [rbp-E2h]
  int v993; // [rsp+1B8h] [rbp-E0h]
  __int64 *v994; // [rsp+1C0h] [rbp-D8h]
  __int64 v995; // [rsp+1C8h] [rbp-D0h]
  __int64 v996; // [rsp+1D0h] [rbp-C8h]
  _DWORD *v997; // [rsp+1D8h] [rbp-C0h]
  char v998[15]; // [rsp+1E0h] [rbp-B8h] BYREF
  char v999; // [rsp+1EFh] [rbp-A9h]
  ...
  *(Unit.QuadPart + 0x5F8) = 0i64;
  ...
  {
    (sub_158CE00)(Unit.QuadPart + 0x600, Unit.QuadPart, PerformanceCount);
...
LABEL_82:
  ...
  *(Unit.QuadPart + 0x3190) = 0;
  ...
  v963 = Unit;
  v90 = qword_4AD09E8;
  v91 = qword_4AD09E8 + 0x330;
  v92 = sub_145DD00(qword_4AD09E8 + 0x330, v70);
  v93 = *(v90 + 0x340);
  if ( v93 == 0xFFFFFFFF )
  {
    v100 = *(v90 + 0x33E);
...
LABEL_158:
  ...
  if ( (*(v134.QuadPart + 0x58) & 4) != 0 )
  {
    ...
    {
      (sub_158CE00)(v134.QuadPart + 0x3450, v134.QuadPart, PerformanceCount);
