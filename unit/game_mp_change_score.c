char __fastcall game_mp_change_score(__int64 a1, __int64 a2)
{
  ...
  __int64 v97; // [rsp+38h] [rbp-80h]
  int v98; // [rsp+48h] [rbp-70h]
  int v99; // [rsp+4Ch] [rbp-6Ch]
  char *Unit_; // [rsp+50h] [rbp-68h] BYREF
  void *v101; // [rsp+58h] [rbp-60h]
  ...
  if ( (v31 & 0xC0) != 0x80 )
  {
    if ( (v31 & 0xC0) == 0x40 )
    {
      if ( (v99 & 1) != 0 )
      {
        ...
        if ( v32 )
        {
          sub_158CE00(v33 + 0x5D0, v33 + 0x580, &Unit_);
          *(v33 + 0x5F0) = Unit_;
        }
      }
      if ( (v99 & 2) != 0 )
      {
        ...
        if ( v32 )
        {
          sub_158CE00(v34 + 0x710, v34 + 0x6C0, &Unit_);
          *(v34 + 0x730) = Unit_;
        }
      }
    }
          ...
          if ( *(game + 0x360) )
          {
            ...
            if ( v102 )
            {
              if ( v102 != 1 )
              {
                ...
                *(v88 + 0xBAA) += v98;
                sub_158CE00(v88 + 0xBB0, v88, v88 + 0xBD0);
                v89 = *(v88 + 8);
                v90 = *(v103 + 0x50);
                if ( *(v103 + 0x50) )
                {
...
LABEL_151:
              ...
              v92 = *(*Unit_ + 0x10B8i64);
              *(v92 + 0xBA8) += v98;
              sub_158CE00(v92 + 0xBB0, v92, v92 + 0xBD0);
              v93 = *(v92 + 8);
              v94 = *(v103 + 0x50);
              if ( *(v103 + 0x50) )
              {
