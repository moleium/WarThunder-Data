void __fastcall sub_F76B0(__int64 a1, unsigned __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  *(a4 + 4) = 0i64;
  v5 = *(a3 + 8);
  if ( (*&screenScaleFactor * v5) > *&epsilon_unk || (v6 = 0.0, (*&screenScaleFactor * v5) < *&dword_449F1AC) )
    v6 = dword_44801E0 / v5;
  if ( (dword_4487E18 * v5) > *&epsilon_unk || (v7 = 0.0, (dword_4487E18 * v5) < *&dword_449F1AC) )
    v7 = *&dword_448938C / v5;
  v8 = *(a3 + 4);
  v285 = a4;
  v306 = a3;
  v305 = (a4 + 4);
  v304 = a2;
  if ( (*&screenScaleFactor * v8) > *&epsilon_unk || (v9 = 0.0, (*&screenScaleFactor * v8) < *&dword_449F1AC) )
    v9 = dword_44801E0 / v8;
  v10 = a5;
  *v321 = v9;
  *&v321[1] = v7;
